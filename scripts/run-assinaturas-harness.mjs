/**
 * Executa o harness de assinaturas/cobrança do modo offline (sem framework de
 ...
 *
 *   node scripts/run-assinaturas-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule("/src/mocks/__harness__/assinaturas-harness.ts");
