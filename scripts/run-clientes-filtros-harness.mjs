/**
 * Executa o harness dos cards de filtro rápido de `/clientes`. Usa o Vite já
 * instalado apenas para resolver o alias `@` e compilar TypeScript sob demanda
 * (ssrLoadModule) — nenhuma dependência nova.
 *
 *   node scripts/run-clientes-filtros-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule(
      "/src/mocks/__harness__/clientes-filtros-harness.ts",
    );
