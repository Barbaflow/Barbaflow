/**
 * Executa o harness das mensagens do formulário de contato. Usa o Vite já
 * instalado apenas para resolver o alias `@` e compilar TypeScript sob demanda
 * (ssrLoadModule) — nenhuma dependência nova.
 *
 *   node scripts/run-mensagens-contato-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule("/src/mocks/__harness__/mensagens-contato-harness.ts");
