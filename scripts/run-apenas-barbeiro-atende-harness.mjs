/**
 * Executa o harness da regra "só barbeiro atende" (migration 20260805200000). Usa o Vite já
 * instalado apenas para resolver o alias `@` e compilar TypeScript sob demanda
 * (ssrLoadModule) — nenhuma dependência nova.
 *
 *   node scripts/run-apenas-barbeiro-atende-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule(
      "/src/mocks/__harness__/apenas-barbeiro-atende-harness.ts",
    );
