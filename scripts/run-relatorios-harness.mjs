/**
 * Executa o harness de relatórios de vendas do modo offline (sem framework de
 ...
 * persistência funcione fora do navegador.
 *
 *   node scripts/run-relatorios-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule("/src/mocks/__harness__/relatorios-harness.ts");
