/**
 * Executa o harness da nota pública por profissional. Usa o Vite já
 * instalado apenas para resolver o alias `@` e compilar TypeScript sob demanda
 * (ssrLoadModule) — nenhuma dependência nova.
 *
 *   node scripts/run-avaliacoes-publicas-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule(
      "/src/mocks/__harness__/avaliacoes-publicas-harness.ts",
    );
