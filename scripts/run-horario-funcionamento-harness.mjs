/**
 * Executa o harness da horário de funcionamento da barbearia. Usa o Vite já
 * instalado apenas para resolver o alias `@` e compilar TypeScript sob demanda
 * (ssrLoadModule) — nenhuma dependência nova.
 *
 *   node scripts/run-horario-funcionamento-harness.mjs
 */
...
async function main() {
  ...
  try {
    const mod = await server.ssrLoadModule(
      "/src/mocks/__harness__/horario-funcionamento-harness.ts",
    );
